...
def  mashup(name,num_video,audio_duration,email_id):
    ...
    request_site=Request("https://www.youtube.com/results?search_query=" + search_keyword,headers={'User-Agent': 'Mozilla/5.0 (iPad; CPU OS 12_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148'}
)
